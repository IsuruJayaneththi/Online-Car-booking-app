...
public class Dri_SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dri__sign_up);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final ProgressDialog mDialog = new ProgressDialog(Dri_SignUp.this);
                ...
                table_user.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            mDialog.dismiss();
                            Toasty.success(Dri_SignUp.this,"Please Log In",Toast.LENGTH_SHORT).show();
                            ...
                            Toasty.success(Dri_SignUp.this,"Sign up successfully  !",Toast.LENGTH_SHORT).show();
                            Intent homeIntent = new Intent(Dri_SignUp.this,Dri_main.class);
